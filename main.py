...
def read_data():
    data = pd.read_excel('./212-Site_25-Hanwha-Solar/2017.xlsx', sheet_name=3)
    test = pd.read_excel('./212-Site_25-Hanwha-Solar/2018.xlsx', sheet_name=3)
    data = data.fillna(0)
    data = data.values
    test = test.fillna(0)
    test = test.values
...
if __name__ == "__main__":
    ...
    for DELAY in range(1440, 21601, 1400):
